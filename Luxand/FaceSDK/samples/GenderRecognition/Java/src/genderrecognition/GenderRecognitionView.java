 ...
 */
public class GenderRecognitionView extends FrameView {
    public GenderRecognitionView(SingleFrameApplication app) {
        super(app);
        ...
        drawingTimer = new Timer(40, new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (FSDKCam.GrabFrame(cameraHandle, imageHandle) == FSDK.FSDKE_OK){
    			    ...
    			    int res = FSDK.GetTrackerFacialAttribute(tracker, 0, IDs[i], "Gender", AttributeValues, 1024);
			    if (FSDK.FSDKE_OK == res) { // draw gender
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(genderrecognition.GenderRecognitionApp.class).getContext().getActionMap(GenderRecognitionView.class, this);
        jButton1.setAction(actionMap.get("buttonStart")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(genderrecognition.GenderRecognitionApp.class).getContext().getResourceMap(GenderRecognitionView.class);
